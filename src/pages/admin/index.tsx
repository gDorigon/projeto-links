...
export function Admin() {
    ...
    function handleRegister(e: FormEvent) {
        ...
        addDoc(collection(db, "links"), {
            ...
            .catch((error) => {
                console.log("ERRO AO CADASTRAR NO BANCO, ERRO: " + error)
            })
        ...
        <div className="flex items-center flex-col min-h-screen pb-7 px-2">
            ...
            <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
                ...
                <section className="flex my-4 gap-5">
                    ...
                    <div className="flex gap-2">
                        <label className="text-white font-medium mt-2 mb-2">Cor do botão</label>
                ...
                {nameInput !== "" && (
                    <div className="flex items-center justify-start flex-col mb-7 p-1 border-gray-100/25 border rounded-md">
                        ...
                        <article
                            className="w-11/12 max-w-lg flex flex-col items-center justify-between bg-zinc-900 rounded px px-1 py-3"
